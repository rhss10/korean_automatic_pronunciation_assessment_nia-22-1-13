...
train_ds.save_to_disk("./train_ds", num_proc=15, max_shard_size="5GB")
valid_ds.save_to_disk("./valid_ds", num_proc=15, max_shard_size="5GB")
valid_ds_small.save_to_disk("./valid_ds_small")
test_ds.save_to_disk("./test_ds", num_proc=15, max_shard_size="5GB")
